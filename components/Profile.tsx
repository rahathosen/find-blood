      ...
      <div className="border rounded-lg p-4 shadow-sm">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm">
              <span className={`font-bold ${profile.status === 'active' ? 'text-green-500' : 'text-red-500'}`}>
        ...
        <p><strong>Present Address:</strong> {profile.presentAddress || 'Not specified'}</p>
        <p><strong>Permanent Address:</strong> {profile.permanentAddress || 'Not specified'}</p>
        <p><strong>Profession:</strong> {profile.profession || 'Not specified'}</p>
        <p><strong>Location:</strong> Latitude: {profile.latitude.toFixed(6)}, Longitude: {profile.longitude.toFixed(6)}</p>
        <p><strong>Gender:</strong> {profile.gender || 'Not specified'}</p>
        <p><strong>Phone Number:</strong> {profile.phoneNumber || 'Not specified'}</p>
        <p><strong>Optional Phone Number:</strong> {profile.optionalPhoneNumber || 'Not specified'}</p>
      </div>
      <button
